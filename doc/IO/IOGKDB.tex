...
\hyperref[em:switches]{inconsistent\_curvature\_drift} &  boolean  \\
...
\hyperref[sec:shape:coefficients]{ds\_dr\_minor\_norm} &  array $N_{sh} \times 1$  \\
...
\hyperref[sec:polgrid]{poloidal\_angle} & array $N_{\theta}\times 1$ \\
...
\hyperref[sec:dvdr]{velocity\_tor\_gradient\_norm} & real \\
\hline
\end{tabularx}\\ 	
};
...
\node[draw,anchor=north west] (total_fluxes_norm) at (1,-15) {
\begin{tabularx}{0.57\textwidth}{|X|M{1.2cm}|}
\hline
\multicolumn{2}{|c|}{\textbf{fluxes\_integrated\_norm (NL)}} \\
\hline
species\_id & integer \\
ids\_properties\_id & integer \\
\hyperref[sec:fluxes]{particles\_phi\_potential} & real \\
\hyperref[sec:fluxes]{particles\_a\_field\_parallel} & real \\
\hyperref[sec:fluxes]{particles\_b\_field\_parallel} & real \\
\hyperref[sec:fluxes]{momentum\_tor\_parallel\_phi\_potential} & real \\
\hyperref[sec:fluxes]{momentum\_tor\_parallel\_a\_field\_parallel} & real \\
\hyperref[sec:fluxes]{momentum\_tor\_parallel\_b\_field\_parallel} & real \\
\hyperref[sec:fluxes]{momentum\_tor\_perpendicular\_phi\_potential} & real \\
\hyperref[sec:fluxes]{momentum\_tor\_perpendicular\_a\_field\_parallel} & real \\
\hyperref[sec:fluxes]{momentum\_tor\_perpendicular\_b\_field\_parallel} & real \\
\hyperref[sec:fluxes]{energy\_phi\_potential} & real \\
\hyperref[sec:fluxes]{energy\_a\_field\_parallel} & real \\
\hyperref[sec:fluxes]{energy\_b\_field\_parallel} & real \\
\hline
\end{tabularx}\\ 				
};
\node[draw,anchor=north west] (fluxes_norm) at (4,-7.2) {
	\begin{tabularx}{0.57\textwidth}{|X|M{1.2cm}|}
	\hline
...
\node[draw,anchor=north east] (moments_norm_rotating_frame) at (25,-11.7) {
...
\draw[->,>=latex,thick] ([xshift=-34.5mm]total_fluxes_norm.north) -- ([xshift=-25mm]species.south);
